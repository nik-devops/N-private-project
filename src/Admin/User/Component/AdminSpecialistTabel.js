...
export default function AdminSpecialistTabel() {

    const [user, setuser] = useState([])

    let history = useHistory();

    async function adminSpecialistlist(req, res) {
        try {
    ...
    function updateSpecialist(id) {
        ...
        history.push(`/admin/editspecialist/${id}`);
        // setTimeout(() => {
                                        ...
                                        <div className="table-responsive mb-4">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-xl-6 col-md-6 col-sm-6 col-6 text-right my-2">
                                                    <a href="/admin/addspecialist"><button className="btn btn-primary"> Add Specialist </button></a>
                                                </div>
                                            </div>


                                            <MaterialTable title="Specialist"
                                                data={user}
                                                columns={columns}
                                                ...
                                                actions={[
                                                    {
                                                        icon: 'edit',
                                                        tooltip: 'Edit User',
                                                        onClick: (event, rowData) => updateSpecialist(rowData._id),
