...
export default function AdminAddChemist() {
                                ...
                                <div className="statbox widget box box-shadow">
                                    <div className="widget-content widget-content-area">
                                        <div className="col-xl-12 col-md-12 col-sm-12 col-12 text-center">
                                            <h4><strong> Chemist </strong></h4>
                                        </div>
                                        <form onSubmit={handleSubmit} >
                                            <div className="form-group mb-4">
                                                <label><strong>Name of chemist</strong></label>
                                                <input
                                                    type="text"
                                            ...
                                            <div className="form-group mb-4">
                                                <label><strong>Address with Geo-tagging</strong></label>
                                                <input
                                                    type="password"
                                                    className="form-control"
                                                    id="password"
